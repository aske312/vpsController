...
export function SystemDnsControl({ dns, dnsDraft, setDnsDraft }: { dns: DnsStatus | null; dnsDraft: DnsSettings | null; setDnsDraft: Dispatch<SetStateAction<DnsSettings | null>> }) {
  const scopes = [["system", "VPS", "DNS самого сервера"], ["wg", "WG", "WireGuard"], ["awg", "AWG", "AmneziaWG"], ["shadowsocks", "SS", "Shadowsocks"], ["vless-reality-xhttp", "VLESS", "Xray VLESS"], ["mihomo", "MI", "Mihomo"]] as const;
