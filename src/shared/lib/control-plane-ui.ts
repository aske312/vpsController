...
export const labels: Record<Tab | Protocol, string> = { overview: "Обзор", channels: "Защищённые каналы", dns: "DNS", security: "Безопасность", application: "Приложение", services: "Службы", wg: "WireGuard", awg: "AmneziaWG", shadowsocks: "Shadowsocks", "vless-reality-xhttp": "VLESS", hysteria2: "Hysteria2", tuic: "TUIC v5", trojan: "Trojan", openvpn: "OpenVPN", ikev2: "IKEv2", clients: "Подключения", mihomo: "Mihomo" };
export const directProtocolOrder: Protocol[] = ["awg", "wg", "vless-reality-xhttp", "hysteria2", "tuic", "trojan", "openvpn", "ikev2", "shadowsocks"];
export const navigationLabels: Record<Tab, string> = { overview: "OVERVIEW", channels: "SECURE CHANNELS", dns: "DNS", security: "SECURITY", application: "APPLICATION", services: "SERVICES", wg: "WIREGUARD", awg: "AMNEZIAWG", shadowsocks: "SHADOWSOCKS", "vless-reality-xhttp": "VLESS", hysteria2: "HYSTERIA2", tuic: "TUIC V5", trojan: "TROJAN", openvpn: "OPENVPN", ikev2: "IKEV2", clients: "CONNECTIONS", mihomo: "MIHOMO" };
export const actionLabels: Record<string, string> = { install: "Установка 312.net", start: "Запуск приложения", stop: "Остановка приложения", restart: "Перезапуск приложения", update: "Обновление приложения", "test-update": "Переход на тестовую версию", "test-rollback": "Возврат к рабочей версии", "network-check": "Проверка сети и туннелей", identity: "Обновление данных сервера", "integrity-check": "Проверка целостности", secure: "Настройка защиты", "safe-update": "Полное обновление сервера", "kernel-update": "Обновление ядра", "vpn-firewall": "Восстановление VPN firewall", optimize: "Оптимизация ресурсов", "service-mode": "Переключение режима и ветки", reboot: "Перезагрузка сервера", poweroff: "Выключение сервера", "protocol-install": "Установка протокола", "protocol-remove": "Удаление протокола", "protocol-update": "Обновление протокола" };
