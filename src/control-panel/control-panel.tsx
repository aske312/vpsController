...
export function ControlPanel() {
  ...
  const [newClientSettings, setNewClientSettings] = useState({ dns: "1.1.1.1, 1.0.0.1", mtu: 1280, keepalive: 25, route_mode: "ipv4" as "all" | "ipv4", shadowsocks_mode: "tcp_and_udp" as "tcp_only" | "tcp_and_udp", timeout: 300, no_delay: true, fingerprint: "chrome" as "chrome" | "firefox" | "safari" });
