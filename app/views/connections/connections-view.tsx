        ...
        <article className="connectionsInventory">
          ...
          <div className="connectionsRows">
            {protocolClients.length ? visibleClients.map((client) => {
              ...
              const protocolLabel = client.protocol === "wg" ? "WG" : client.protocol === "awg" ? "AWG" : client.protocol === "shadowsocks" ? "SS" : client.protocol === "hysteria2" ? "HY2" : client.protocol === "tuic" ? "TUIC" : "VLESS";
